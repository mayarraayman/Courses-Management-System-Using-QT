...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(670, 10, 120, 65));
        pushButton->setMaximumSize(QSize(120, 65));
        QFont font;
        ...
        pushButton_2->setGeometry(QRect(670, 80, 120, 65));
        pushButton_2->setMaximumSize(QSize(120, 65));
        pushButton_2->setFont(font);
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(670, 150, 120, 65));
        pushButton_3->setFont(font);
        pushButton_4 = new QPushButton(centralwidget);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(670, 220, 120, 65));
